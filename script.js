window.onload = function() {
  ...
  let source = Marzipano.ImageUrlSource.fromString("https://raw.githubusercontent.com/aframevr/aframe/v0.9.0/examples/boilerplate/panorama/puydesancy.jpg");
  let view = new Marzipano.RectilinearView({yaw: 0, pitch: 0, roll: 0, fov: Math.PI/2 }, limiter);
  ...
  let source1 = Marzipano.ImageUrlSource.fromString("https://raw.githubusercontent.com/mistic100/Photo-Sphere-Viewer/dev/example/Bryce-Canyon-By-Jess-Beauchemin.jpg");
  let view1 = new Marzipano.RectilinearView({yaw: 0, pitch: 0, roll: 0, fov: Math.PI/2 }, limiter);
  ...
  imgHotspot.src = 'https://raw.githubusercontent.com/google/marzipano/master/demos/sample-tour/img/play.png';
